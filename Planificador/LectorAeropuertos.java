...
public class LectorAeropuertos {
    ...
    public List<AeropuertoAlgoritmo> leerAeropuertos(String rutaArchivo) {
        List<AeropuertoAlgoritmo> aeropuertos = new ArrayList<>();
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(rutaArchivo))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                try {
                    AeropuertoAlgoritmo aeropuerto = new AeropuertoAlgoritmo();
                    aeropuerto.setId(Integer.parseInt(partes[0].trim()));
                    aeropuerto.setOaci(partes[1].trim());
                    ...
                    aeropuerto.setCapacidadAlmacen(Integer.parseInt(partes[6].trim()));
